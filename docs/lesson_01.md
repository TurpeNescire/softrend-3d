...
## What's the goal?
This is a toy project to teach myself software 3D rendering techniques by building a triangle rasterizer entirely from scratch. Here are some of the features currently implemented that these docs will cover implementing:
